...
def get_download_links(url):
    ...
    if is_gofile_url(url):
        ...
        # --- ADDED GOFILE BYPASS GUIDE LOGIC ---
        try:
            ...
            msg += f"🎉 <b>Guide To Bypass Gofile Limits :-</b>\n\n"
            msg += f"➕ <b>Original File URL :-</b>\n{url}\n\n"
            msg += f"➕ <b>FileID :-</b> {content_id}\n\n"
            msg += f"➕ <b>Bypass Link (Add ID at End) :-</b>\n<a href='{worker_link}'>{worker_link}</a>\n\n"
            msg += f"➕ <b>Folder API (If above is a folder) :-</b>\n<a href='{worker_api}'>{worker_api}</a>"
        except Exception as e:
            logging.error(f"GoFile Guide Error: {e}")
